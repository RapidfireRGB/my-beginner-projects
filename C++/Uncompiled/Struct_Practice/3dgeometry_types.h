#ifndef STRUCTPRACTICE_3DGEOMETRYTYPES_H
#define STRUCTPRACTICE_3DGEOMETRYTYPES_H
...
struct sphere final : threedimensional {
	...
	//void hemi() {
	// transform sphere to hemisphere
	//}

	//void quadrant() {
	// transform sphere to quadrant (quarter sphere)
	//}
...
//};
#endif //STRUCTPRACTICE_3DGEOMETRYTYPES_H